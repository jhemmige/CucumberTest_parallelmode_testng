...
if (value.equalsIgnoreCase("Your store name")){
	...
	WebElement chooseStore=driver.findElement(choosestorename);
	
	//wait.waitforElement(chooseStore,90);
	chooseStore.click();
	...
	WebElement chooseStore1=driver.findElement(choosestorename1);
	
	
	//wait.waitforElement(chooseStore1,3000);
	chooseStore1.click();
